...
<div class="card card-flush h-lg-50">
  ...
  <div class="card-body pt-5">
    ...
    <div class="d-flex flex-stack">
      <!--begin::Section-->
      <a href="https://toastmasters.org" target="_blank" class="text-primary fw-semibold fs-6 me-2">Toastmasters International</a>
      <!--end::Section-->
      <!--begin::Action-->
    ...
    <div class="d-flex flex-stack">
      <!--begin::Section-->
      <a href="#" class="text-primary fw-semibold fs-6 me-2">Facebook page</a>
      <!--end::Section-->
      <!--begin::Action-->
      <button type="button" class="btn btn-icon btn-sm h-auto btn-color-gray-400 btn-active-color-primary justify-content-end">
        <!--begin::Svg Icon | path: icons/duotune/arrows/arr095.svg-->
    ...
    <div class="d-flex flex-stack">
      <!--begin::Section-->
      <a href="https://tmtimer.calebgrove.com/" target="_blank" class="text-primary fw-semibold fs-6 me-2">Speech Timer</a>
      <!--end::Section-->
      <!--begin::Action-->
      <button type="button" class="btn btn-icon btn-sm h-auto btn-color-gray-400 btn-active-color-primary justify-content-end">
        <!--begin::Svg Icon | path: icons/duotune/arrows/arr095.svg-->
