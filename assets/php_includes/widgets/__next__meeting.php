          ...
          <div class="mb-7">
            ...
            <div class="d-flex flex-stack mb-6">
              ...
              <div class="flex-shrink-0 me-5">
                <span class="text-gray-400 fs-7 fw-bold me-2 d-block lh-1 pb-1">Next meeting</span>
          ...
          <div class="mb-6">
            ...
            <div class="d-flex">
              ...
              <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 mb-3">
                ...
                <span class="ms-n1">18:30</span></span>
                <!--end::Number-->
                <!--begin::Label-->
            ...
            <div class="d-flex">
              ...
              <div class="border border-gray-300 border-dashed rounded min-w-100px w-100 py-2 px-4 mb-3">
                <!--begin::Number-->
                <span class="fs-6 text-gray-700 fw-bold">
                <span class="ms-n1">The Plaza Hotel</span></span>
                <!--end::Number-->
                <!--begin::Label-->
