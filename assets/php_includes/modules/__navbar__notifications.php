          ...
          ?>
						...
						<div class="d-flex flex-stack py-3">
							...
							<div class="d-flex align-items-center me-2">
								<!--begin::Code-->
								<span class="w-23px badge badge-light-<?=$logLine['labeltype']?> me-4"><span class="fa fa-<?=$logLine['labelicon']?>"></span></span>
								<!--end::Code-->
								<!--begin::Title-->
								<span class="text-gray-800 fw-semibold"><?=$logLine['operation']?></span>
								<!--end::Title-->
							</div>
							<!--end::Section-->
							<!--begin::Label-->
							<span class="badge badge-light fs-8"><?=$logLine['timestamp']?></span>
							<!--end::Label-->
						</div>
						<!--end::Item-->
						<?php
